    ...
    create  table
      "takehome"."dev_bronze"."int_visits__with_patient_details__dbt_tmp"
...
visits as (
    ...
    select * from "takehome"."dev_staging"."stg_visits"
...
conditions as (
    ...
    select * from "takehome"."dev_staging"."stg_conditions"
